...
test_batch = 50
localtime_n = ['2019-11-18 09:52:02']
for localtime_i in localtime_n:
    ...
    test_ske, test_block = load_test(ske, block, id_seperate, train_ousize,
                                     num_gaussians, test_batch, pre_proc)
    del id_seperate
    ...
    test_outp, test_losses = test(test_ske, test_block, DM_general, DM_param,
                            test_batch, train_insize, model, mdn_loss, device, start_time)
